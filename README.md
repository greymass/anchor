...
The most recent (v1.3.10-beta.1) release can downloaded using these links:

- [Windows Installer](https://github.com/greymass/anchor/releases/download/v1.3.10-beta.1/win-anchor-wallet-1.3.10-beta.1.exe)
- [macOS Package](https://github.com/greymass/anchor/releases/download/v1.3.10-beta.1/mac-anchor-wallet-1.3.10-beta.1-x64.dmg)
- [Linux (deb)](https://github.com/greymass/anchor/releases/download/v1.3.10-beta.1/linux-anchor-wallet-1.3.10-beta.1-amd64.deb)
- [Linux (AppImage)](https://github.com/greymass/anchor/releases/download/v1.3.10-beta.1/linux-anchor-wallet-1.3.10-beta.1-x86_64.AppImage)
