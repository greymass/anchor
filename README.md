...
The most recent (v1.2.5) release can downloaded using these links:

- [Windows Installer](https://github.com/greymass/anchor/releases/download/v1.2.5/win-anchor-wallet-1.2.5.exe)
- [macOS Package](https://github.com/greymass/anchor/releases/download/v1.2.5/mac-anchor-wallet-1.2.5.dmg)
- [Linux (deb)](https://github.com/greymass/anchor/releases/download/v1.2.5/linux-anchor-wallet-1.2.5-amd64.deb)
- [Linux (AppImage)](https://github.com/greymass/anchor/releases/download/v1.2.5/linux-anchor-wallet-1.2.5-x86_64.AppImage)
